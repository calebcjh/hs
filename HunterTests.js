...
tests.testSnakeTrap = function() {
  var p1 = new Player([], new Hunter());
  var p2 = new Player([], new Hunter());
  var game = new Hearthstone([p1, p2], 0);
  p1.hand.push(HunterCards.SnakeTrap.copy());
  p1.hand.push(HunterCards.StarvingBuzzard.copy());
  p1.currentMana = 4;
  p1.turn.playCard(p1.hand[0]);
  p1.turn.playCard(p1.hand[0], 0);
...
tests.testSnipe = function() {
  var p1 = new Player([], new Hunter());
  var p2 = new Player([], new Mage());
  var game = new Hearthstone([p1, p2], 0);
  p1.hand.push(HunterCards.Snipe.copy());
  p1.currentMana = 2;
  p1.turn.playCard(p1.hand[0]);
  p1.turn.endTurn();
  p2.hand.push(MageCards.MirrorImage.copy());
...
tests.testUnleashTheHounds = function() {
  var p1 = new Player([], new Hunter());
  var p2 = new Player([], new Mage());
  var game = new Hearthstone([p1, p2], 0);
  p1.hand.push(HunterCards.UnleashTheHounds.copy());
  p1.currentMana = 3;
  p1.turn.playCard(p1.hand[0]);
  assert(0, p1.minions.length);
  p1.turn.endTurn();
  ...
  p1.turn.minionAttack(p1.minions[2], p2.minions[0]);
  p1.turn.minionAttack(p1.minions[3], p2.minions[0]);
  assert(2, p2.minions.length);
};
